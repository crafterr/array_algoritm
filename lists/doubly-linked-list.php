...
$double->insertAtFirst("Adam");
$double->insertAtFirst("Grzesiek");
$double->insertAtFirst("Maciek");
$double->insertAtLast("Ostatni");

$double->displayBackward();

$double->displayForward();
//$double->deleteFirst();
